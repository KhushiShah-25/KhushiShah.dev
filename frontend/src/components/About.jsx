...
stack:      ["HTML","CSS","JS","React","Node","Express","PostgreSQL"]`}
        ...
        <div className={"About-info"}>
          <div className={"About-row"}><strong>phone</strong><a href="tel:+919266805633">+91 92668 05633</a></div>
          <div className={"About-row"}><strong>email</strong><span style={{color:'var(--muted2)'}}>to be added soon</span></div>

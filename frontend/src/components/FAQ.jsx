...
const FAQS = [
  ...
  { q:'Are you open to internships?',         a:"Absolutely! Actively looking for internship opportunities in full-stack or frontend development. Based in Greater Noida and open to remote too." },
  { q:'What are you currently learning?',     a:"Currently deep-diving into Data Structures and Algorithms with C++, plus exploring advanced React patterns and PostgreSQL query optimisation." },
  { q:'Can you take on freelance projects?',  a:"Yes — open to freelance web development projects, especially full-stack apps and portfolio sites. Let's discuss!" },
  { q:'How do I contact you?',                a:"Reach me on +91 92668 05633 or fill out the contact form. I aim to respond within 24 hours." },
]
